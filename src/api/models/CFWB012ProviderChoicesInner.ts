...
import type { CFWB012ProviderChoicesInnerProviderAddress } from './CFWB012ProviderChoicesInnerProviderAddress';
import {
    CFWB012ProviderChoicesInnerProviderAddressFromJSON,
    CFWB012ProviderChoicesInnerProviderAddressFromJSONTyped,
    CFWB012ProviderChoicesInnerProviderAddressToJSON,
    CFWB012ProviderChoicesInnerProviderAddressToJSONTyped,
} from './CFWB012ProviderChoicesInnerProviderAddress';

/**
 * 
 * @export
 * @interface CFWB012ProviderChoicesInner
 */
export interface CFWB012ProviderChoicesInner {
    /**
     * Indicates the provider name selected by the Applicant.
     * @type {string}
     * @memberof CFWB012ProviderChoicesInner
     */
    providerName: string;
    /**
     * If applicable, indicates the program # of the provider.
     * @type {string}
     * @memberof CFWB012ProviderChoicesInner
     */
    ...
    /**
     * 
     * @type {CFWB012ProviderChoicesInnerProviderAddress}
     * @memberof CFWB012ProviderChoicesInner
     */
    providerAddress: CFWB012ProviderChoicesInnerProviderAddress;
}

/**
 * Check if a given object implements the CFWB012ProviderChoicesInner interface.
 */
export function instanceOfCFWB012ProviderChoicesInner(value: object): value is CFWB012ProviderChoicesInner {
    if (!('providerName' in value) || value['providerName'] === undefined) return false;
    if (!('providerAddress' in value) || value['providerAddress'] === undefined) return false;
    return true;
}

export function CFWB012ProviderChoicesInnerFromJSON(json: any): CFWB012ProviderChoicesInner {
    return CFWB012ProviderChoicesInnerFromJSONTyped(json, false);
}

export function CFWB012ProviderChoicesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): CFWB012ProviderChoicesInner {
    if (json == null) {
        return json;
    }
    return {
        ...
        'programNumber': json['ProgramNumber'] == null ? undefined : json['ProgramNumber'],
        'providerAddress': CFWB012ProviderChoicesInnerProviderAddressFromJSON(json['ProviderAddress']),
    };
}

export function CFWB012ProviderChoicesInnerToJSON(json: any): CFWB012ProviderChoicesInner {
    return CFWB012ProviderChoicesInnerToJSONTyped(json, false);
}

export function CFWB012ProviderChoicesInnerToJSONTyped(value?: CFWB012ProviderChoicesInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'ProviderAddress': CFWB012ProviderChoicesInnerProviderAddressToJSON(value['providerAddress']),
    };
}
