...
/**
 * Check if a given object implements the FutureForm interface.
 */
export function instanceOfFutureForm(value: object): value is FutureForm {
    return true;
}

export function FutureFormFromJSON(json: any): FutureForm {
    return FutureFormFromJSONTyped(json, false);
}

export function FutureFormFromJSONTyped(json: any, ignoreDiscriminator: boolean): FutureForm {
    if (json == null) {
        return json;
    }
    return {
...
export function FutureFormToJSON(json: any): FutureForm {
    return FutureFormToJSONTyped(json, false);
}

export function FutureFormToJSONTyped(value?: FutureForm | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
