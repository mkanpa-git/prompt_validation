 ...
 * 
 * @export
 * @interface CFWB012FamilyMembersInner
 */
export interface CFWB012FamilyMembersInner {
    /**
     * The Last Name of the family member/child in the household who do not need Child Care.
     * @type {string}
     * @memberof CFWB012FamilyMembersInner
     */
    lastName: string;
    /**
     * The First Name of the family member/child in the household who do not need Child Care.
     * @type {string}
     * @memberof CFWB012FamilyMembersInner
     */
    firstName: string;
    /**
     * The Middle Initial of the family member/child in the household who do not need Child Care.
     * @type {string}
     * @memberof CFWB012FamilyMembersInner
     */
    mI?: string | null;
    /**
     * Indicates the Relationship between the Applicant and the family member/child in the household who do not need Child Care.
     * @type {string}
     * @memberof CFWB012FamilyMembersInner
     */
    relationshipToApplicant: CFWB012FamilyMembersInnerRelationshipToApplicantEnum;
    /**
     * Indicates the DoB of the family member/child in the household who do not need Child Care.
     * @type {string}
     * @memberof CFWB012FamilyMembersInner
     */
    dateOfBirth: string;
    /**
     * Indicates the Gender of the family member/child in the household who do not need Child Care.
     * @type {string}
     * @memberof CFWB012FamilyMembersInner
     */
    sex: CFWB012FamilyMembersInnerSexEnum;
    /**
     * Indicates the Ethnicity of the family member/child in the household who do not need Child Care.
     * @type {string}
     * @memberof CFWB012FamilyMembersInner
     */
    ethnicity?: CFWB012FamilyMembersInnerEthnicityEnum;
    /**
     * Indicates the Race of the family member/child in the household who do not need Child Care. AI - Native American or Alaskan Native; AS - Asian; BL - Black or African American; HP - Native Hawaiian or Pacific Islander; WH - White
     * @type {Set<string>}
     * @memberof CFWB012FamilyMembersInner
     */
    race?: Set<CFWB012FamilyMembersInnerRaceEnum> | null;
    /**
     * Indicates the Social Security Number of the family member/child in the household who do not need Child Care. The SSN may be used by federal, state, and local agencies to prevent duplication of services and fraud, and for Federal Reporting.
     * @type {string}
     * @memberof CFWB012FamilyMembersInner
     */
    sSN?: string | null;
 ...
 * @export
 */
export const CFWB012FamilyMembersInnerRelationshipToApplicantEnum = {
    Spouse: 'Spouse',
    Partner: 'Partner',
...
export type CFWB012FamilyMembersInnerRelationshipToApplicantEnum = typeof CFWB012FamilyMembersInnerRelationshipToApplicantEnum[keyof typeof CFWB012FamilyMembersInnerRelationshipToApplicantEnum];

/**
 * @export
 */
export const CFWB012FamilyMembersInnerSexEnum = {
    Male: 'Male',
    Female: 'Female'
} as const;
export type CFWB012FamilyMembersInnerSexEnum = typeof CFWB012FamilyMembersInnerSexEnum[keyof typeof CFWB012FamilyMembersInnerSexEnum];

/**
 * @export
 */
export const CFWB012FamilyMembersInnerEthnicityEnum = {
    Hispanic: 'Hispanic',
    Latino: 'Latino',
    No: 'No',
    PreferNotToAnswer: 'Prefer not to answer'
} as const;
export type CFWB012FamilyMembersInnerEthnicityEnum = typeof CFWB012FamilyMembersInnerEthnicityEnum[keyof typeof CFWB012FamilyMembersInnerEthnicityEnum];

/**
 * @export
 */
export const CFWB012FamilyMembersInnerRaceEnum = {
    Ai: 'AI',
    As: 'AS',
    Bl: 'BL',
    Hp: 'HP',
...
export type CFWB012FamilyMembersInnerRaceEnum = typeof CFWB012FamilyMembersInnerRaceEnum[keyof typeof CFWB012FamilyMembersInnerRaceEnum];


/**
 * Check if a given object implements the CFWB012FamilyMembersInner interface.
 */
export function instanceOfCFWB012FamilyMembersInner(value: object): value is CFWB012FamilyMembersInner {
...
export function CFWB012FamilyMembersInnerFromJSON(json: any): CFWB012FamilyMembersInner {
    return CFWB012FamilyMembersInnerFromJSONTyped(json, false);
}

export function CFWB012FamilyMembersInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): CFWB012FamilyMembersInner {
    if (json == null) {
        return json;
    }
    return {
...
export function CFWB012FamilyMembersInnerToJSON(json: any): CFWB012FamilyMembersInner {
    return CFWB012FamilyMembersInnerToJSONTyped(json, false);
}

export function CFWB012FamilyMembersInnerToJSONTyped(value?: CFWB012FamilyMembersInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
