...
import type { CFWB012 } from './CFWB012';
import {
    instanceOfCFWB012,
    CFWB012FromJSON,
    CFWB012FromJSONTyped,
    CFWB012ToJSON,
} from './CFWB012';
import type { FutureForm } from './FutureForm';
import {
    instanceOfFutureForm,
    FutureFormFromJSON,
    FutureFormFromJSONTyped,
    FutureFormToJSON,
} from './FutureForm';
 ...
 * @export
 */
export type ApplicationSubmissionFormsInnerFormInputDocument = CFWB012 | FutureForm;

export function ApplicationSubmissionFormsInnerFormInputDocumentFromJSON(json: any): ApplicationSubmissionFormsInnerFormInputDocument {
    return ApplicationSubmissionFormsInnerFormInputDocumentFromJSONTyped(json, false);
}

export function ApplicationSubmissionFormsInnerFormInputDocumentFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApplicationSubmissionFormsInnerFormInputDocument {
    if (json == null) {
        return json;
    }
    ...
    if (instanceOfCFWB012(json)) {
        return CFWB012FromJSONTyped(json, true);
    }
    if (instanceOfFutureForm(json)) {
        return FutureFormFromJSONTyped(json, true);
    }

    return {} as any;
}

export function ApplicationSubmissionFormsInnerFormInputDocumentToJSON(json: any): any {
    return ApplicationSubmissionFormsInnerFormInputDocumentToJSONTyped(json, false);
}

export function ApplicationSubmissionFormsInnerFormInputDocumentToJSONTyped(value?: ApplicationSubmissionFormsInnerFormInputDocument | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    if (instanceOfCFWB012(value)) {
        return CFWB012ToJSON(value as CFWB012);
    }
    if (instanceOfFutureForm(value)) {
        return FutureFormToJSON(value as FutureForm);
    }
