 ...
 * 
 * @export
 * @interface ApplicationSubmissionStatusEventsInner
 */
export interface ApplicationSubmissionStatusEventsInner {
    /**
     * 
     * @type {string}
     * @memberof ApplicationSubmissionStatusEventsInner
     */
    ...
    statusTime: string;
    /**
     * --- Backlog for future consideration --- An optional flag for processing agency to specify if the status update notification is strictly meant for use by internal system/ process communication only.  Unless explicitly suppressed by the processing agency by setting this indicator to 'Yes', by default, status update is considered to be applicant facing for MyCity to appropriately inform (via Portal Dashboard) / notify (via email) the Applicant.
     * @type {string}
     * @memberof ApplicationSubmissionStatusEventsInner
     */
    suppressApplicantNotification?: ApplicationSubmissionStatusEventsInnerSuppressApplicantNotificationEnum;
}
 ...
 * @export
 */
export const ApplicationSubmissionStatusEventsInnerSuppressApplicantNotificationEnum = {
    Yes: 'Yes',
    No: 'No',
    True: 'True',
    False: 'False'
} as const;
export type ApplicationSubmissionStatusEventsInnerSuppressApplicantNotificationEnum = typeof ApplicationSubmissionStatusEventsInnerSuppressApplicantNotificationEnum[keyof typeof ApplicationSubmissionStatusEventsInnerSuppressApplicantNotificationEnum];


/**
 * Check if a given object implements the ApplicationSubmissionStatusEventsInner interface.
 */
export function instanceOfApplicationSubmissionStatusEventsInner(value: object): value is ApplicationSubmissionStatusEventsInner {
    if (!('processingAgencyCode' in value) || value['processingAgencyCode'] === undefined) return false;
    if (!('applicationStatus' in value) || value['applicationStatus'] === undefined) return false;
    if (!('statusTime' in value) || value['statusTime'] === undefined) return false;
    return true;
}

export function ApplicationSubmissionStatusEventsInnerFromJSON(json: any): ApplicationSubmissionStatusEventsInner {
    return ApplicationSubmissionStatusEventsInnerFromJSONTyped(json, false);
}

export function ApplicationSubmissionStatusEventsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApplicationSubmissionStatusEventsInner {
    if (json == null) {
        return json;
    }
    return {
        
        'statusEventId': json['StatusEventId'] == null ? undefined : json['StatusEventId'],
        'processingAgencyCode': json['ProcessingAgencyCode'],
        'agencyCaseID': json['AgencyCaseID'] == null ? undefined : json['AgencyCaseID'],
        'applicationStatus': json['ApplicationStatus'],
        'statusReason': json['StatusReason'] == null ? undefined : json['StatusReason'],
        'agencyComments': json['AgencyComments'] == null ? undefined : json['AgencyComments'],
        'statusTime': json['StatusTime'],
        'suppressApplicantNotification': json['SuppressApplicantNotification'] == null ? undefined : json['SuppressApplicantNotification'],
    };
}

export function ApplicationSubmissionStatusEventsInnerToJSON(json: any): ApplicationSubmissionStatusEventsInner {
    return ApplicationSubmissionStatusEventsInnerToJSONTyped(json, false);
}

export function ApplicationSubmissionStatusEventsInnerToJSONTyped(value?: ApplicationSubmissionStatusEventsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'StatusEventId': value['statusEventId'],
        'ProcessingAgencyCode': value['processingAgencyCode'],
        'AgencyCaseID': value['agencyCaseID'],
        'ApplicationStatus': value['applicationStatus'],
        'StatusReason': value['statusReason'],
        'AgencyComments': value['agencyComments'],
        'StatusTime': value['statusTime'],
        'SuppressApplicantNotification': value['suppressApplicantNotification'],
    };
}
