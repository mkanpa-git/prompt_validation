...
import type { CFWB012IncomeInformationSourcesInner } from './CFWB012IncomeInformationSourcesInner';
import {
    CFWB012IncomeInformationSourcesInnerFromJSON,
    CFWB012IncomeInformationSourcesInnerFromJSONTyped,
    CFWB012IncomeInformationSourcesInnerToJSON,
    CFWB012IncomeInformationSourcesInnerToJSONTyped,
} from './CFWB012IncomeInformationSourcesInner';

/**
 * 
 * @export
 * @interface CFWB012IncomeInformation
 */
export interface CFWB012IncomeInformation {
    /**
     * 
     * @type {Array<CFWB012IncomeInformationSourcesInner>}
     * @memberof CFWB012IncomeInformation
     */
    sources?: Array<CFWB012IncomeInformationSourcesInner>;
    /**
     * The total amount (in $) received from the sources.
     * @type {number}
     * @memberof CFWB012IncomeInformation
     */
    totalIncome: number;
...
/**
 * Check if a given object implements the CFWB012IncomeInformation interface.
 */
export function instanceOfCFWB012IncomeInformation(value: object): value is CFWB012IncomeInformation {
    if (!('totalIncome' in value) || value['totalIncome'] === undefined) return false;
    return true;
}

export function CFWB012IncomeInformationFromJSON(json: any): CFWB012IncomeInformation {
    return CFWB012IncomeInformationFromJSONTyped(json, false);
}

export function CFWB012IncomeInformationFromJSONTyped(json: any, ignoreDiscriminator: boolean): CFWB012IncomeInformation {
    if (json == null) {
        return json;
    }
    return {
        
        'sources': json['Sources'] == null ? undefined : ((json['Sources'] as Array<any>).map(CFWB012IncomeInformationSourcesInnerFromJSON)),
        'totalIncome': json['TotalIncome'],
    };
}

export function CFWB012IncomeInformationToJSON(json: any): CFWB012IncomeInformation {
    return CFWB012IncomeInformationToJSONTyped(json, false);
}

export function CFWB012IncomeInformationToJSONTyped(value?: CFWB012IncomeInformation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'Sources': value['sources'] == null ? undefined : ((value['sources'] as Array<any>).map(CFWB012IncomeInformationSourcesInnerToJSON)),
