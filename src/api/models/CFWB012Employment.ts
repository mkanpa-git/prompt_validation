 ...
 * 
 * @export
 * @interface CFWB012Employment
 */
export interface CFWB012Employment {
    /**
     * 
     * @type {Job}
     * @memberof CFWB012Employment
     */
    applicant1stJob?: Job;
    /**
     * 
     ...
     * @memberof CFWB012Employment
     */
    secondParent1stJob?: Job;
    /**
     * 
     * @type {Job}
     * @memberof CFWB012Employment
     */
    secondParent2ndJob?: Job;
}

/**
 * Check if a given object implements the CFWB012Employment interface.
 */
export function instanceOfCFWB012Employment(value: object): value is CFWB012Employment {
    return true;
}

export function CFWB012EmploymentFromJSON(json: any): CFWB012Employment {
    return CFWB012EmploymentFromJSONTyped(json, false);
}

export function CFWB012EmploymentFromJSONTyped(json: any, ignoreDiscriminator: boolean): CFWB012Employment {
    if (json == null) {
        return json;
    }
    return {
        
        'applicant1stJob': json['Applicant1stJob'] == null ? undefined : JobFromJSON(json['Applicant1stJob']),
        'applicant2ndJob': json['Applicant2ndJob'] == null ? undefined : JobFromJSON(json['Applicant2ndJob']),
        'secondParent1stJob': json['SecondParent1stJob'] == null ? undefined : JobFromJSON(json['SecondParent1stJob']),
        'secondParent2ndJob': json['SecondParent2ndJob'] == null ? undefined : JobFromJSON(json['SecondParent2ndJob']),
    };
}

export function CFWB012EmploymentToJSON(json: any): CFWB012Employment {
    return CFWB012EmploymentToJSONTyped(json, false);
}

export function CFWB012EmploymentToJSONTyped(value?: CFWB012Employment | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'Applicant1stJob': JobToJSON(value['applicant1stJob']),
        'Applicant2ndJob': JobToJSON(value['applicant2ndJob']),
        'SecondParent1stJob': JobToJSON(value['secondParent1stJob']),
        'SecondParent2ndJob': JobToJSON(value['secondParent2ndJob']),
    };
}
