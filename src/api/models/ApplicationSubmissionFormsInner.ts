...
import type { ApplicationSubmissionFormsInnerFormInputDocument } from './ApplicationSubmissionFormsInnerFormInputDocument';
import {
    ApplicationSubmissionFormsInnerFormInputDocumentFromJSON,
    ApplicationSubmissionFormsInnerFormInputDocumentFromJSONTyped,
    ApplicationSubmissionFormsInnerFormInputDocumentToJSON,
    ApplicationSubmissionFormsInnerFormInputDocumentToJSONTyped,
} from './ApplicationSubmissionFormsInnerFormInputDocument';

/**
 * 
 * @export
 * @interface ApplicationSubmissionFormsInner
 */
export interface ApplicationSubmissionFormsInner {
    /**
     * 
     * @type {string}
     * @memberof ApplicationSubmissionFormsInner
     */
    formId?: ApplicationSubmissionFormsInnerFormIdEnum;
    /**
     * 
     * @type {string}
     * @memberof ApplicationSubmissionFormsInner
     */
    formName?: ApplicationSubmissionFormsInnerFormNameEnum;
    /**
     * 
     * @type {ApplicationSubmissionFormsInnerFormInputDocument}
     * @memberof ApplicationSubmissionFormsInner
     */
    formInputDocument?: ApplicationSubmissionFormsInnerFormInputDocument;
}
 ...
 * @export
 */
export const ApplicationSubmissionFormsInnerFormIdEnum = {
    Cfwb012: 'CFWB-012'
} as const;
export type ApplicationSubmissionFormsInnerFormIdEnum = typeof ApplicationSubmissionFormsInnerFormIdEnum[keyof typeof ApplicationSubmissionFormsInnerFormIdEnum];

/**
 * @export
 */
export const ApplicationSubmissionFormsInnerFormNameEnum = {
    ApplicationForChildCareAssistance: 'Application for Child Care Assistance'
} as const;
export type ApplicationSubmissionFormsInnerFormNameEnum = typeof ApplicationSubmissionFormsInnerFormNameEnum[keyof typeof ApplicationSubmissionFormsInnerFormNameEnum];


/**
 * Check if a given object implements the ApplicationSubmissionFormsInner interface.
 */
export function instanceOfApplicationSubmissionFormsInner(value: object): value is ApplicationSubmissionFormsInner {
    return true;
}

export function ApplicationSubmissionFormsInnerFromJSON(json: any): ApplicationSubmissionFormsInner {
    return ApplicationSubmissionFormsInnerFromJSONTyped(json, false);
}

export function ApplicationSubmissionFormsInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): ApplicationSubmissionFormsInner {
    if (json == null) {
        return json;
    }
    return {
        ...
        'formInputDocument': json['FormInputDocument'] == null ? undefined : ApplicationSubmissionFormsInnerFormInputDocumentFromJSON(json['FormInputDocument']),
    };
}

export function ApplicationSubmissionFormsInnerToJSON(json: any): ApplicationSubmissionFormsInner {
    return ApplicationSubmissionFormsInnerToJSONTyped(json, false);
}

export function ApplicationSubmissionFormsInnerToJSONTyped(value?: ApplicationSubmissionFormsInner | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'FormInputDocument': ApplicationSubmissionFormsInnerFormInputDocumentToJSON(value['formInputDocument']),
    };
}
