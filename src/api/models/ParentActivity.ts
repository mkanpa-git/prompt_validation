...
/**
 * Work/Activity/Travel Time Schedule of the applicant and second parent/Spouse
 * @export
 * @interface ParentActivity
 */
export interface ParentActivity {
    /**
     * Indicates Start Time Work/Activity/Travel Time Schedule, in military time format.
     * @type {string}
     * @memberof ParentActivity
     */
    sundayFrom?: string;
    /**
     * Indicates End Time Work/Activity/Travel Time Schedule, in military time format.
     * @type {string}
     * @memberof ParentActivity
     */
    sundayTo?: string;
...
/**
 * Check if a given object implements the ParentActivity interface.
 */
export function instanceOfParentActivity(value: object): value is ParentActivity {
    return true;
}

export function ParentActivityFromJSON(json: any): ParentActivity {
    return ParentActivityFromJSONTyped(json, false);
}

export function ParentActivityFromJSONTyped(json: any, ignoreDiscriminator: boolean): ParentActivity {
    if (json == null) {
        return json;
    }
    return {
        
        'sundayFrom': json['SundayFrom'] == null ? undefined : json['SundayFrom'],
        'sundayTo': json['SundayTo'] == null ? undefined : json['SundayTo'],
        'mondayFrom': json['MondayFrom'] == null ? undefined : json['MondayFrom'],
        'mondayTo': json['MondayTo'] == null ? undefined : json['MondayTo'],
        'tuesdayFrom': json['TuesdayFrom'] == null ? undefined : json['TuesdayFrom'],
        'tuesdayTo': json['TuesdayTo'] == null ? undefined : json['TuesdayTo'],
        'wednesdayFrom': json['WednesdayFrom'] == null ? undefined : json['WednesdayFrom'],
        'wednesdayTo': json['WednesdayTo'] == null ? undefined : json['WednesdayTo'],
        'thursdayFrom': json['ThursdayFrom'] == null ? undefined : json['ThursdayFrom'],
        'thursdayTo': json['ThursdayTo'] == null ? undefined : json['ThursdayTo'],
        'fridayFrom': json['FridayFrom'] == null ? undefined : json['FridayFrom'],
        'fridayTo': json['FridayTo'] == null ? undefined : json['FridayTo'],
        'saturdayFrom': json['SaturdayFrom'] == null ? undefined : json['SaturdayFrom'],
        'saturdayTo': json['SaturdayTo'] == null ? undefined : json['SaturdayTo'],
    };
}

export function ParentActivityToJSON(json: any): ParentActivity {
    return ParentActivityToJSONTyped(json, false);
}

export function ParentActivityToJSONTyped(value?: ParentActivity | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'SundayFrom': value['sundayFrom'],
        'SundayTo': value['sundayTo'],
        'MondayFrom': value['mondayFrom'],
        'MondayTo': value['mondayTo'],
        'TuesdayFrom': value['tuesdayFrom'],
        'TuesdayTo': value['tuesdayTo'],
        'WednesdayFrom': value['wednesdayFrom'],
        'WednesdayTo': value['wednesdayTo'],
        'ThursdayFrom': value['thursdayFrom'],
        'ThursdayTo': value['thursdayTo'],
        'FridayFrom': value['fridayFrom'],
        'FridayTo': value['fridayTo'],
        'SaturdayFrom': value['saturdayFrom'],
        'SaturdayTo': value['saturdayTo'],
    };
}
